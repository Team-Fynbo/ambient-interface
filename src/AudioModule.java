...
public class AudioModule implements Runnable {
	...
	public AudioModule(String audioSunny, String audioThunder, String audioRain, String audioWind, String audioSnow,
			String audioCloudy, String audioOther, int weather) {
	...
	private String getAudio(int weather) {
		...
		case 1:
			audioFile = this.audioSunny;
			break;

		case 2:
			audioFile = this.audioRain;
			break;

		case 3:
			audioFile = this.audioWind;
			break;

		case 4:
			audioFile = this.audioThunder;
			break;

		case 5:
			audioFile = this.audioSnow;
			break;

		case 6:
			audioFile = this.audioCloudy;
			break;

		default:
			audioFile = this.audioOther;
			break;
		}
	...
	private void playAudio(String audioFile) {
		...
		try {
			...
			while (!this.stop && clip.isRunning())
				; // play audio while it is not killed and has time left.
